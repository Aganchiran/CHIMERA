...
public class CombatModelTest {
    ...
    @Test
    public void equals() {
        final CombatModel cm1 = new CombatModel("Name");
        cm1.setId(1);
        final CombatModel cm2 = new CombatModel("Name");
        cm2.setId(1);
        final CombatModel cm3 = new CombatModel("Name");
        cm3.setId(2);
    ...
    public void contentsTheSame() {
        ...
        final CombatModel cm2 = new CombatModel("Name");
        cm2.setId(1);
        final CombatModel cm3 = new CombatModel("Name2");
        cm3.setId(2);
