...
public class CamCombatsFragment extends Fragment {
    ...
    private CampaignCombatsListVM camComListVM;
    ...
    public static CamCombatsFragment newInstance(final CampaignModel campaignModel) {
        final CamCombatsFragment fragment = new CamCombatsFragment();
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, final ViewGroup container,
        ...
        camComListVM = ViewModelProviders.of(this).get(CampaignCombatsListVM.class);
        ...
        if (campaignModel != null) {
            final LiveData<List<CombatModel>> combatListLiveData =
                    camComListVM.getCampaignCombats(campaignModel.getId());
        ...
        deleteArea.setOnDragListener(new AbstractDropToListener() {
            ...
            protected void onDrop() {
                if (adapter.getFlyingItemPos() != -1) {
                    final CombatModel combatModel = adapter.getItemAt(adapter.getFlyingItemPos());
                    deleteCombat(combatModel);
                }
            }
        });
    ...
    private void setupGrid(LiveData<List<CombatModel>> data, RecyclerView recyclerView) {
        ...
        adapter.setMenuActions(new CombatAdapter.MenuActions() {
            ...
            public void deleteCombat(final CombatModel combatModel) {
                CamCombatsFragment.this.deleteCombat(combatModel);
            }
        });
        ...
        recyclerView.setOnDragListener(new DragItemListener(adapter) {
            ...
            protected void onDrop(final View hiddenView) {
                ...
                new ReorderCombatAsyncTask(adapter, camComListVM).execute();
            }
        });
    ...
    private void cancelCombatDeletion(final View rootView) {
    ...
    private void createCombat(final String name) {
        ...
        final CombatModel combatModel = new CombatModel(name, campaignModel.getId());
        camComListVM.insert(combatModel);
    }
    ...
    private void deleteCombat(final CombatModel combatModel){
        new AlertDialog.Builder(getContext(), R.style.DialogTheme)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(final DialogInterface dialog, int which) {
                        camComListVM.delete(combatModel);
                    }
                })
    ...
    private void deleteCombats(){
        new AlertDialog.Builder(getContext(), R.style.DialogTheme)
                .setTitle(getResources().getString(R.string.delete_combats))
                .setMessage(getResources().getString(R.string.delete_combats_confirmation))
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(final DialogInterface dialog, int which) {
    ...
    private static class ReorderCombatAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        private ReorderCombatAsyncTask(final CombatAdapter adapter, final CampaignCombatsListVM camChaListVM) {
        ...
        protected Void doInBackground(final Void... voids) {
            for (int i = 0; i < adapter.getItemCount(); i++) {
                final CombatModel combatModel = adapter.getItemAt(i);
