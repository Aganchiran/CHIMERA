...
public class CreateEditCharacterVM extends AndroidViewModel implements ItemVM<CharacterModel> {

    private CharacterRepo characterRepo;
    private LiveData<List<CharacterModel>> allCharacters;

    public CreateEditCharacterVM(@NonNull Application application) {
        super(application);
